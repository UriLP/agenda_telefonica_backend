...
final class Version20221028192945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contacto (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, numero VARCHAR(255) NOT NULL, apellido VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
